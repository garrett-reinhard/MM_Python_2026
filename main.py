...
class Campaign:
    ...
    def load_experiments(self):
        ...
        for index , filename in enumerate(os.listdir("./CampaignSetup/Experiments")):
            ...
            new_experiment.campaign_csv = f"./save_data/{new_experiment.campaign_name}/edbo_planner.csv"
            os.makedirs(f"./save_data/{new_experiment.campaign_name}", exist_ok=True)   
            print(new_experiment.campaign_csv)
            new_experiment.reaction_scope = EDBOplus().generate_reaction_scope(
                                components=experiment_setup["reaction_components"], 
                                filename=new_experiment.campaign_csv,

...
class NMR:
    ...
    def scan(self, file_name, save_directory, shim_file=None):
        ROOTPATH = r"C:\Users\dryan.local\Desktop\Molecule Maker Python"
        """Take NMR scan\nInputs: Filename, directory"""
        TRIGGER_PATH = r'C:\Users\dryan.local\Desktop\Molecule Maker Python\Devices\NMR\scan_trigger.txt'
        print("RUNNING SCAN")
